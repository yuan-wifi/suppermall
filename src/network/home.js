...
export function getHomeMultidata() {
  ...
  return new Promise(function(reslove,reject){
      reslove(datam)  //状态由等待变为成功，传的参数作为then函数中成功函数的实参
  })
}
